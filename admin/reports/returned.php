...
$records = get_report_records('returned', $dateFrom, $dateTo, 'return_date');

render_app_start('Returned Books Report', 'returned_report');
?>
<section class="panel">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
            <p class="text-sm uppercase tracking-[0.25em] text-slate-500">Reports</p>
            <h3 class="mt-2 text-2xl font-semibold text-library-ink">Returned books report</h3>
        </div>
    ...
    <form method="get" class="mt-6 grid gap-4 md:grid-cols-3">
        ...
        <div class="flex items-end gap-3">
            ...
            <a href="<?= e(url('admin/reports/returned.php')) ?>" class="btn-secondary">Reset</a>
        </div>
    </form>
    ...
    <div class="mt-6 overflow-x-auto">
        <table class="data-table">
            ...
            <tbody class="divide-y divide-slate-100">
                <?php if ($records === []): ?>
                    <tr>
                        <td colspan="5" class="px-3 py-6 text-center text-slate-500">No returned records found.</td>
                    </tr>
                <?php endif; ?>
